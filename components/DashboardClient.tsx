              ...
              <div className="space-y-6 text-sm sm:text-base">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-gray-600">Cédula</p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-gray-600">Referencia</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-gray-600">Titular</p>
                        <p className="text-gray-900">{selectedEntry.accountHolder}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedEntry.tickets.map((ticket, i) => (
                      <Badge
                        key={i}
                        variant="secondary"
